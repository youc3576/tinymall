package com.menethil.tinymall.db.util;
...
public class OrderUtil {
    ...
    public static String orderStatusText(TinymallOrder order) {
    ...
    public static OrderHandleOption build(TinymallOrder order){
        int status = order.getOrderStatus().intValue();
...
//            status.add((short)402);
    ...
    public static boolean isCreateStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_CREATE == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isPayStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_PAY == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isShipStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_SHIP == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isConfirmStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_CONFIRM == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isCancelStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_CANCEL == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isAutoCancelStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_AUTO_CANCEL == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isRefundStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_REFUND == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isRefundConfirmStatus(TinymallOrder tinymallOrder) {
        return OrderUtil.STATUS_REFUND_CONFIRM == tinymallOrder.getOrderStatus().shortValue();
    }

    public static boolean isAutoConfirmStatus(TinymallOrder tinymallOrder) {
