...
public class AdminOrderController {
    ...
    public Object detail(@LoginAdmin Integer adminId, Integer id) {
        ...
        TinymallOrder order = orderService.findById(id);
        List<TinymallOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
        TinymallUserVo user = userService.findUserVoById(order.getUserId());
        Map<String, Object> data = new HashMap<>();
