...
public class WxTopicController {
    ...
    public Object list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        List<TinymallTopic> topicList = topicService.queryList(page, size);
    ...
    public Object detail(Integer id) {
        ...
        TinymallTopic topic = topicService.findById(id);
    ...
    public Object related(Integer id) {
        ...
        List<TinymallTopic> topicRelatedList = topicService.queryRelatedList(id, 0, 4);
