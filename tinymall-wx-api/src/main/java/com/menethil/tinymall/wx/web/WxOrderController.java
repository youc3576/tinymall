...
public class WxOrderController {
    ...
    private String detailedAddress(TinymallAddress tinymallAddress) {
    ...
    public Object list(@LoginUser Integer userId, Integer showType,
        ...
        List<TinymallOrder> orderList = orderService.queryByOrderStatus(userId, orderStatus);
    ...
    public Object detail(@LoginUser Integer userId, Integer orderId) {
        ...
        // 订单信息
        TinymallOrder order = orderService.findById(orderId);
        if (null == order) {
    ...
    public Object submit(@LoginUser Integer userId, @RequestBody String body) {
        ...
        // 收货地址
        TinymallAddress checkedAddress = addressService.findById(addressId);
        ...
        try {
            ...
            for (TinymallCart checkGoods : checkedGoodsList) {
                ...
                TinymallProduct product = productService.findById(productId);
    ...
    public Object cancel(@LoginUser Integer userId, @RequestBody String body) {
        ...
        try {
            ...
            // 商品货品数量增加
            List<TinymallOrderGoods> orderGoodsList = orderGoodsService.queryByOid(orderId);
            for (TinymallOrderGoods orderGoods : orderGoodsList) {
    ...
    public Object payNotify(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            TinymallOrder order = orderService.findBySn(orderSn);
            if (order == null) {
    ...
    public Object comment(@LoginUser Integer userId, Integer orderId, Integer goodsId) {
        ...
        List<TinymallOrderGoods> orderGoodsList = orderGoodsService.findByOidAndGid(orderId, goodsId);
        ...
        TinymallOrderGoods orderGoods = orderGoodsList.get(0);
