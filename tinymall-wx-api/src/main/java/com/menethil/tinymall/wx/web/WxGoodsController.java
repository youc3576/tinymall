...
public class WxGoodsController {
    ...
    public Object detail(@LoginUser Integer userId, Integer id) {
        ...
        // 商品属性
        List<TinymallGoodsAttribute> goodsAttributeList = goodsAttributeService.queryByGid(id);
        ...
        // 商品规格对应的数量和价格
        List<TinymallProduct> productList = productService.queryByGid(id);

        // 商品问题，这里是一些通用问题
        List<TinymallIssue> issue = goodsIssueService.query();

        // 商品品牌商
        TinymallBrand brand = brandService.findById(info.getBrandId());
    ...
    public Object list(Integer categoryId, Integer brandId, String keyword, Boolean isNew, Boolean isHot,
        ...
        //查询列表数据
        List<TinymallGoods> goodsList = goodsService.querySelective(categoryId, brandId, keyword, isHot, isNew, page, size, sort, order);
