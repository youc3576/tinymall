...
import com.menethil.tinymall.core.store.config.TencentConfig;
...
public class TencentOsService implements ObjectStorageService {
    ...
    private String getBaseUrl() {
        return "https://" + tencentConfig.getBucketName() + ".cos-website." + tencentConfig.getRegion() + ".myqcloud.com/";
    }
    ...
    public void store(MultipartFile file, String keyName) {
        try {
            ...
            PutObjectRequest putObjectRequest = new PutObjectRequest(tencentConfig.getBucketName(), keyName, file.getInputStream(), objectMetadata);
    ...
    public void delete(String keyName) {
        try {
            getCOSClient().deleteObject(tencentConfig.getBucketName(), keyName);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @Override
    public String generateUrl(String keyName, String localUrl) {
